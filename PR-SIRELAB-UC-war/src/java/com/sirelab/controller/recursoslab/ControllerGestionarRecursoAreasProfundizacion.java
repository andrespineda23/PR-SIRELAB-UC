...
@ManagedBean
@SessionScoped
public class ControllerGestionarRecursoAreasProfundizacion implements Serializable {
    ...
    public ControllerGestionarRecursoAreasProfundizacion() {
    }
    ...
    public void init() {
        ...
        listaFacultades = gestionarRecursoAreaProfundizacionBO.consultarFacultadesRegistradas();
        altoTabla = "150";
        inicializarFiltros();
    ...
    public void actualizarFacultades() {
        ...
        if (Utilidades.validarNulo(parametroFacultad)) {
            parametroDepartamento = new Departamento();
            listaDepartamentos = gestionarRecursoAreaProfundizacionBO.consultarDepartamentosPorIDFacultad(parametroFacultad.getIdfacultad());
    ...
    public void actualizarDepartamentos() {
        ...
        if (Utilidades.validarNulo(parametroDepartamento)) {
            parametroLaboratorio = new Laboratorio();
            listaLaboratorios = gestionarRecursoAreaProfundizacionBO.consultarLaboratoriosPorIDDepartamento(parametroDepartamento.getIddepartamento());
    ...
    public void actualizarNuevoFacultades(int tipoRegistro) {
        ...
        if (tipoRegistro == 0) {
            if (Utilidades.validarNulo(nuevoFacultadAreaProfundizacion)) {
                nuevoDepartamentoAreaProfundizacion = null;
                listaDepartamentos = gestionarRecursoAreaProfundizacionBO.consultarDepartamentosPorIDFacultad(nuevoFacultadAreaProfundizacion.getIdfacultad());
            ...
            if (Utilidades.validarNulo(editarFacultad)) {
                ...
                listaDepartamentos = gestionarRecursoAreaProfundizacionBO.consultarDepartamentosPorIDFacultad(editarFacultad.getIdfacultad());
                activarNuevoDepartamento = false;
                activarNuevoLaboratorio = true;
                listaLaboratorios = null;
    ...
    public void actualizarNuevoDepartamentos(int tipoRegistro) {
        ...
        if (tipoRegistro == 0) {
            if (Utilidades.validarNulo(nuevoDepartamentoAreaProfundizacion)) {
                nuevoLaboratorioAreaProfundizacion = null;
                listaLaboratorios = gestionarRecursoAreaProfundizacionBO.consultarLaboratoriosPorIDDepartamento(nuevoDepartamentoAreaProfundizacion.getIddepartamento());
            ...
            if (Utilidades.validarNulo(editarDepartamento)) {
                editarLaboratorio = null;
                listaLaboratorios = gestionarRecursoAreaProfundizacionBO.consultarLaboratoriosPorIDDepartamento(editarDepartamento.getIddepartamento());
                activarNuevoLaboratorio = false;
            } else {
                activarNuevoLaboratorio = true;
                listaLaboratorios = null;
    ...
    public void cargarInformacionAreaProfundizacionEditar(BigInteger idArea) {
        try {
            areaProfundizacionEditar = gestionarRecursoAreaProfundizacionBO.obtenerAreaProfundizacionPorIDAreaProfundizacion(idArea);
    ...
    public void almacenarModificacion() {
        ...
        try {
            ...
            gestionarRecursoAreaProfundizacionBO.modificarInformacionAreaProfundizacion(areaProfundizacionEditar);
